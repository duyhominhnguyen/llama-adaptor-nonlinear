...
def get_args_parser():
    ...
    parser.add_argument("--random_init", default=False, type=bool, help="choose random init")
    parser.add_argument("--typ_act", default="identity", help="type of activation for prompt")
    parser.add_argument("--hid_acti_func", default=None, help="type of activation for hypernetwork")
    parser.add_argument("--hidden_dim", default=None, type=int, help="hidden dim of hypernetwork")
    parser.add_argument("--typ_gate", default="random", help="type of gating")
    return parser
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        print("==========type activation:", args.typ_act)
